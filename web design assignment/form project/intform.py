...
def hello_world():
    ...
    if request.method=='GET':
        ...
        temp=simplot(func,llimit,ulimit,div)
        temp_trap=traplot(func,llimit,ulimit,div)
        return render_template('cform.html',simarea=simarea,traparea=traparea,temp=temp,temp_trap=temp_trap)
...
def simplot(f,a,b,n):
    ...
    plt.savefig('C:/Users/hp/Desktop/form project/static/img/foo'+str(w)+'.png', bbox_inches='tight')
    temp='/static/img/foo'+str(w)+'.png'
...
def traplot(f,a,b,n):
     ...
     plt.xlabel('X-AXIS')
     plt.ylabel('Y-AXIS')
     plt.savefig('C:/Users/hp/Desktop/form project/static/img/noo'+str(w)+'.png', bbox_inches='tight')
     temp_trap=('/static/img/noo'+str(w)+'.png')
